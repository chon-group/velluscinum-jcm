...
+!validateContract(Task,ArtId,TransactionID): 
   ...
   velluscinum.stampTransaction(S,P,Q,TransactionID);
...
+!paymentProof(ArtID,PaymentTransaction): bigchaindbNode(S) 
   ...
   velluscinum.stampTransaction(S,P,Q,PaymentTransaction);
   .concat("Payment:OK;Value:",Price,M);
   velluscinum.transferNFT(S,P,Q,ContractID,W,M,payed(ArtID)).